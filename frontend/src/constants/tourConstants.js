...
export const TOUR_REVIEW_REQUEST = "TOUR_REVIEW_REQUEST";
export const TOUR_REVIEW_SUCCESS = "TOUR_REVIEW_SUCCESS";
export const TOUR_REVIEW_FAIL = "TOUR_REVIEW_FAIL";
export const TOUR_REVIEW_RESET = "TOUR_REVIEW_RESET";