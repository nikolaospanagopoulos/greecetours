...
export const ORDER_STARTED_REQUEST = 'ORDER_STARTED_REQUEST'
export const ORDER_STARTED_SUCCESS = 'ORDER_STARTED_SUCCESS'
export const ORDER_STARTED_FAIL = 'ORDER_STARTED_FAIL'
export const ORDER_STARTED_RESET = 'ORDER_STARTED_RESET'